...
<head>
    ...
    <link rel="shortcut icon" href="./img/admin.ico" type="image/ico" />
    <title>Đăng nhập Admin - Hydanz</title>
</head>
                ...
                <div class="auth-from ">
                    <div class="auth-from__container ">
                        <div class="auth-from_header ">
                            <h3 class="auth-from_heading " style="color:rgba(207, 8, 8, 0.8)"><b>Đăng Nhập Nhân Viên (Admin)</b></h3>
                        ...
                        <form action="xulydnad.php?do=login" method="POST">

                            <div class="containerr">
                                <input type="text" class="auth-form_input " placeholder="Tên đăng nhập " name="tendnnv"
                                    required>
                            </div>
                            <br>
                            <div class="containerr">
                                <input type="password" placeholder="Mật khẩu " name="matkhaunv" id="upass">
                                <span class="show-btn"><i class="fas fa-eye" onclick="togglePassword()"></i></span>
                            </div>
                            ...
                            <div class="auth-form_control ">
                                <input class="btn--primary " type="submit" name="dangnhapad" value="Đăng Nhập">
