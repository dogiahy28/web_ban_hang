        ...
        <div class="container">
            <div>
                <p style="text-align: left; font-size: 2rem;">
                    ...
                    <a style="text-decoration: none" href="giohang.php" class="connect-link">Giỏ hàng</a>
                    <a href="donhang.php" style="float:right; text-decoration:none"><i class="fas fa-file-invoice"
            ...
            <div class=" category">
                ...
                <table id="cart" class="table table-hover table-condensed">
                    ...
                    <tbody>
                    <tr>
                        <td style="text-align: center; vertical-align: middle;"><?php echo $i; $sl = $i;?></td>
                        <td style="text-align: center; vertical-align: middle;"><?php echo $cart_item['id']; ?></td>
                        <td style="text-align: center; vertical-align: middle;"><a href="chitietsp.php?id=<?php echo $cart_item['id'] ?>"><img src="./img/<?php echo $cart_item['hinhanh']; ?> " width="180px"></a></td>
                    ...
                    <tr>
                        ...
                        <br>
                            ...
                            <button name="muahang" style="background-color:rgba(221, 30, 30, 0.8); width:150px; height:35px; font-size:1.5rem;">
                                <a style="text-decoration: none" href="index.php"><b> Mua ngay</b></a>
                            </button>
                        </td>
                    </tr>
                    </tbody>
