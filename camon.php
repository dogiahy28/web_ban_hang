            ...
            <div class=" category">
                ...
                <table id="cart" class="table table-hover table-condensed">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;"><?php echo number_format($cart_item['giasp'],0,".","."); ?>VND</td>
                        <td style="text-align: center; vertical-align: middle;"><?php echo number_format($thanhtien,0,".","."); ?>VND</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;"><p style="font-size:17px"><b><?php echo number_format($tongtien,0,".","."); ?>VND</b></p></td>
            ...
            <div class="modal__body ">
                <div class="auth-from ">
                    ...
                    <div class="auth-form_socials">
                        <a href="index.php" class="btn btn-with--icon btn-color-login">
                            Trang chủ
                        </a>
                        <a href="donhang.php" class="btn btn-with--icon btn-color-register">
                            Đơn mua
                        </a>
