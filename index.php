...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
                    ...
                    <div class="col col-c-12 col-12">
                        <div class="banner-content">
                            ...
                            <div class=" banner-img">
                                <img class="slide" src="./img/banner1.jpg" alt="">
                            </div>
    ...
    <main>
        ...
        <div class="grid wide">
            ...
            <div class="row product_SPBC">
                ...
                <form method="POST" action="themgiohang.php?id=<?php echo $row_san_pham['MA_SP'] ?>">
        ...
        <div class="grid wide ">
            <div class="row ">
                ...
                <div class="col col-3 col-c-12 ">
                    ...
                    <ul class="footer-list ">
                        <li class="footer-item "><a href="#4" class="footer-link ">Cân Sức Khỏe</a></li>
                        <li class="footer-item "><a href="#3" class="footer-link ">Máy Đo Đường Huyết</a></li>
                        <li class="footer-item "><a href="#5" class="footer-link ">Khẩu trang</a></li>
                        <li class="footer-item "><a href="#2" class="footer-link ">Máy Đo Huyết Áp</a></li>
                        <li class="footer-item "><a href="#1" class="footer-link ">Máy Massage</a></li>
