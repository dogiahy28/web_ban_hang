                    ...
                    <div class="col col-c-12 col-12">
                        <div class="banner-content">
                            ...
                            <div class="grid wide-support">
                                ...
                                <div>
                                    <form method="POST" action="themgiohangdn.php?id=<?php echo $row_chitietsp['MA_SP'] ?>">
                                    ...
                                    <div class="contact-form">
                                        ...
                                        <!-- <button class="home-product-item-button-2">
                                            <a href="giohangdn.php?id=<?php echo $_SESSION['id_kh'] ?>"> <b style="font-size:1.7rem">Chọn mua<b></a>
                                        </button> -->
                                        <?php  } else { ?>
