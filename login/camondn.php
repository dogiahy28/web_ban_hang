...
<head>
    ...
    <script src="../chitietsp.php" type="text/javascript"></script>
        ...
        <?php
            ...
            <div>
                <p style="text-align: left; font-size: 2rem;">
                    ...
                    <a href="dsdonhang.php" style="float:right"><i class="fas fa-file-invoice"
            ...
            <div class=" category">
                ...
                <form action="thanhtoandn.php" method="POST" style="text-align: center;">
                        ...
                        <input type="hidden" name="hoten" value="<?php echo $row_dn['TEN_KH'] ?>">
                        <input type="hidden" name="sdt" value="<?php echo $row_dn['SDT_KH'] ?>">
                        <input type="hidden" name="email" value="<?php echo $row_dn['EMAIL_KH'] ?>">
                        <input type="hidden" name="diachi" value="<?php echo $row_dn['DIA_CHI_KH'] ?>"> -->
                ...
                <div class="auth-from ">
                    <div class="auth-from__container ">
                        <div class="auth-form-info">
                            <h3 class="auth-from_heading" style="color:rgba(207, 8, 8, 0.8); text-align:center; font-size:2.5rem;">
                            <b><i class="fas fa-check-circle"></i> Đặt hàng thành công!</b></h3>

                        </div>
                        <br>
                        <div class="auth-form-info">
                            <img src="../img/camon.png" style="height: 180px; width: 180px;">
                            <br>
                            <b style="font-size: 2rem;">Cảm ơn bạn vì đã mua hàng tại Hydanz!</b>
                        </div>

                    </div><br>
                    <div class="auth-form_socials">
                        <a href="trangchudn.php?id=<?php $_SESSION['id_kh'] ?>" class="btn btn-with--icon btn-color-login">
                            Trang chủ
                        </a>
                        <a href="dsdonhangdn.php" class="btn btn-with--icon btn-color-register">
                            Đơn mua
                        </a>
            ...
            <!-- <div class="row ">
                <div class="col col-3 col-c-12 ">
                    ...
                    <ul class="footer-list ">
                        <li class="footer-item "><a href="lienhe.html" class="footer-link ">Liên Hệ</a></li>
                        <li class="footer-item "><a href="hotro.html" class="footer-link ">Hỗ Trợ</a></li>
                        <li class="footer-item "><a href="chinhsach.html" class="footer-link ">Chính Sách</a></li>
                        <li class="footer-item "><a href="huongdan.html" class="footer-link ">Hướng Dẫn Mua Hàng</a>
                        </li>
                ...
                <div class="col col-3 col-c-12 ">
                    ...
                    <ul class="footer-list ">
                        <li class="footer-item "><a href="tintuc.html" class="footer-link ">Tin Tức</a></li>
                        <li class="footer-item "><a href="tuyendung.html" class="footer-link ">Tuyển Dụng</a></li>
                        <li class="footer-item "><a href="dieukhoan.html" class="footer-link ">Điều Khoản</a></li>
                        <li class="footer-item "><a href="videoclip.html" class="footer-link ">Video Clip</a></li>
                        <li class="footer-item "><a href="yhoc.html" class="footer-link ">Y Học Quanh Ta</a></li>
                    </ul>
                </div>
                <div class="col col-3 col-c-12 ">
