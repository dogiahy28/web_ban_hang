            ...
            <div class="container">
                ...
                <table id="cart" class="table table-hover table-condensed">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;"><a href="chitietspdn.php?id=<?php echo $row['MA_SP']; ?>"><img src="../img/<?php echo $row['HINH_ANH_SP']?>" style="width:250px;height:200px"></a></td>
