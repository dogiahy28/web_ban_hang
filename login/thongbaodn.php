            ...
            <div class="row product_SPBC">
                <div class="col col-3 col-c-3">
                    <div class="sph home-product-item">
                        ...
                        <h4 class="home-product-item__name">
                            <a href="chitietspdn.php?id=2">Máy đo huyết áp tự động Omron HEM-8712
                                <br><br>
                                Trạng thái: Còn hàng
                            </a>
                        </h4>
                ...
                <div class="col col-3 col-c-3">
                    <div class="sph home-product-item">
                        ...
                        <h4 class="home-product-item__name">
                            <a href="chitietspdn.php?id=20">Khẩu trang D&J KN - 95
                                <br><br>
                                Trạng thái: Còn hàng
                            </a>
                        </h4>
                ...
                <div class="col col-3 col-c-3">
                    <div class="sph home-product-item">
                        ...
                        <h4 class="home-product-item__name">
                            <a href="chitietspdn.php?id=9">Cân sức khỏe cơ học Laica PS - 2018
                                <br><br>
                                Trạng thái: Còn hàng
                            </a>
                        </h4>
                ...
                <div class="col col-3 col-c-3">
                    <div class="sph home-product-item">
                        ...
                        <h4 class="home-product-item__name">
                            <a href="chitietspdn.php?id=6">Máy massage cầm tay đa năng
                ...
                <div class="auth-from ">
                    <div class="auth-from__container ">
                        <div class="auth-from_header ">
                            <h3 class="auth-from_heading" style="color:rgba(207, 8, 8, 0.8)"><b>Thông Báo</b></h3>
                        ...
                        <div class="auth-form-info">
                            <img src="../img/thongbaonull.jfif" style="height: 150px; width: 150px;">
                            <br><br>
                            <a style="font-size: 2rem">Bạn không có thông báo!</a>
                            <p></p>
